...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        op.f("test_suites_owner_fkey"), "test_suites", "users", ["owner"], ["id"]
    )
    ...
    op.drop_constraint(None, "test_runs", schema="public", type_="foreignkey")
    op.create_foreign_key(
        op.f("test_runs_test_id_fkey"), "test_runs", "tests", ["test_id"], ["id"]
    )
    op.create_foreign_key(
        op.f("test_runs_created_by_fkey"), "test_runs", "users", ["created_by"], ["id"]
    )
    op.create_foreign_key(
        op.f("test_runs_environment_id_fkey"),
        "test_runs",
    ...
    op.alter_column("test_runs", "test_id", existing_type=sa.UUID(), nullable=False)
    ...
    op.drop_constraint(
        None, "run_time_environments", schema="public", type_="foreignkey"
    )
    op.create_foreign_key(
        op.f("run_time_environments_created_by_fkey"),
        "run_time_environments",
    ...
    op.drop_constraint(
        None, "organization_memberships", schema="public", type_="foreignkey"
    )
    op.drop_constraint(
        None, "organization_memberships", schema="public", type_="foreignkey"
    )
